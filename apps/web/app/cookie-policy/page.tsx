...
export const metadata = {
  title: "Política de Cookies - Cuevana 3",
  description: "Política de Cookies para Cuevana 3",
};
        ...
        <ContentContainer className="w-full flex flex-col items-center">
          <LegalPage title="Cookie Policy">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Cuevana 3 does not run third-party ad networks, remarketing
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                sites are separate from Cuevana 3. They may use their own
