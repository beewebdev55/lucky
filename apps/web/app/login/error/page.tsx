...
const authErrorCopy: Record<string, AuthErrorCopy> = {
  ...
  Verification: {
    ...
    detail:
      "Request a fresh link using the same email address, then open the newest email from Cuevana 3.",
  },
  AccessDenied: {
    title: "Access denied",
  ...
  InvalidCallbackUrl: {
    ...
    detail: "Start again from Cuevana 3 instead of an old or copied link.",
  },
  InvalidEndpoints: {
  ...
  UntrustedHost: {
    ...
    detail: "Open Cuevana 3 from its normal address and try again.",
  },
  MissingCSRF: {
...
export const metadata: Metadata = {
  title: "Error al Iniciar Sesión | Cuevana 3",
  description: "Hubo un problema al iniciar sesión en Cuevana 3.",
  keywords: ["Cuevana 3", "Error de Inicio de Sesión", "Autenticación", "Magic Link"],
  openGraph: {
    type: "website",
    url: `${SITE_URL}/login/error`,
    title: "Sign In Error | Cuevana 3",
    description: "There was a problem signing in to Cuevana 3.",
    images: [
      {
