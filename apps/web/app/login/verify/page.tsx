...
export const metadata: Metadata = {
  title: "Verificar Correo Electrónico | Cuevana 3",
  description: "Revisa tu correo electrónico para obtener el enlace mágico e iniciar sesión en Cuevana 3",
  keywords: ["Cuevana 3", "Verificar Correo Electrónico", "Magic Link", "Autenticación"],
  openGraph: {
    type: "website",
    url: `${SITE_URL}/login/verify`,
    title: "Verify Email | Cuevana 3",
    description: "Check your email for the magic link to sign in to Cuevana 3",
    images: [
      {
      ...
      <Card className="overflow-hidden rounded-2xl border-white/12 bg-zinc-950/72 text-white shadow-[0_24px_80px_rgba(0,0,0,0.55)] backdrop-blur-xl">
        ...
        <CardContent className="space-y-6 px-6 pb-6 pt-2 text-center sm:px-8 sm:pb-8">
          ...
          <p className="text-xs leading-5 text-zinc-500">
            Having trouble?{" "}
            <Link
              href="https://github.com/Nyumat/Cuevana 3"
              target="_blank"
