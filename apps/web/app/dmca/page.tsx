...
export const metadata = {
  title: "Política de DMCA - Cuevana 3",
  description: "Política de DMCA e información de derechos de autor para Cuevana 3",
};
          ...
          <LegalPage title="DMCA Policy">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                What Is on Cuevana 3
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                Cuevana 3 is a discovery app. We show metadata, images,
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                If you believe something on Cuevana 3 itself infringes your
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>The exact Cuevana 3 URL or item at issue.</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                makes sense. Repeated abuse of Cuevana 3 accounts or features
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                with the subject "Copyright Inquiry - Cuevana 3". False or
