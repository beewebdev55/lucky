  ...
  return (
    <div className="relative mx-auto min-h-[calc(100vh-7rem)] w-full max-w-7xl px-4 pt-10 pb-14">
          ...
          <section className="border-b border-white/10 px-4 py-5 md:px-6">
            ...
            <div className="divide-y divide-white/8">
              ...
              {!hideHero ? (
                <SettingSwitchRow
                  icon={ImageIcon}
                  title="HÃ©roe estÃ¡tico"
                  description="Imagen de fondo en lugar de trÃ¡ileres automÃ¡ticos"
              ...
              <SettingSwitchRow
                icon={Volume2}
                title="Sonidos al pasar el ratÃ³n"
                description="Reproducir sonidos al pasar el ratÃ³n sobre pÃ³steres"
                ...
                <div className="min-w-0 flex-1 space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      ref={nameInputRef}
                      placeholder="Â¿CÃ³mo deberÃ­amos llamarte?"
                      value={displayName}
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="rounded-md border border-white/10 bg-black/20 px-3 py-2 text-sm text-zinc-300">
                      {userEmail || "IniciÃ³ sesiÃ³n con MyAnimeList (sin correo configurado)"}
                    </p>
                  </div>
                </div>
              </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Â¿Eliminar tu cuenta?</AlertDialogTitle>
            <AlertDialogDescription>
