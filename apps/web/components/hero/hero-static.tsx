...
export function StaticHero({
  ...
  const isSearchPage = pathname === "/buscar" || !!route;
  ...
  const isCatalogPage =
    ...
    pathname.startsWith("/personaas") ||
    pathname.startsWith("/tendencias") ||
  ...
  const isWatchlistPage = pathname.includes("/mi-lista");
  const isSettingsPage = pathname.includes("/settings");
  const isHistoryPage = pathname.startsWith("/historial");
