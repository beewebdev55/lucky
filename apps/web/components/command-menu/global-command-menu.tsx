...
const BROWSE_ITEMS: NavCommandItem[] = [
  ...
  { label: "Movies", href: "/peliculas", icon: Clapperboard },
  { label: "TV Shows", href: "/series", icon: Tv },
  { label: "Anime", href: "/anime", icon: BookOpen },
  { label: "People", href: "/personaas", icon: Users },
  { label: "Trending", href: "/tendencias", icon: TrendingUp },
  { label: "Search", href: "/buscar", icon: Search },
];
...
const DISCOVER_ITEMS: NavCommandItem[] = [
  { label: "Popular Movies", href: "/peliculas/popular", icon: Compass },
  { label: "Top Rated Movies", href: "/peliculas/top-rated", icon: Compass },
  { label: "Now Playing", href: "/peliculas/now-playing", icon: Compass },
  { label: "Upcoming Movies", href: "/peliculas/upcoming", icon: Compass },
  { label: "Popular TV", href: "/series/popular", icon: Compass },
  { label: "Top Rated TV", href: "/series/top-rated", icon: Compass },
  { label: "Airing Today", href: "/series/airing-today", icon: Compass },
  { label: "On The Air", href: "/series/on-the-air", icon: Compass },
];

const ACCOUNT_ITEMS: NavCommandItem[] = [
  { label: "Watchlist", href: "/mi-lista", icon: Bookmark },
  ...
  return (
    <CommandDialog open={open} onOpenChange={setOpen}>
      ...
      <DialogDescription className="sr-only">
        Search for pages and actions across Cuevana 3
      </DialogDescription>
