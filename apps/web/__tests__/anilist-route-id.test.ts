...
describe("anilist route ids", () => {
  ...
  it("resolves tv detail route id from pathname for anime ids", () => {
    expect(resolveTvDetailRouteId("/series/anilist-113417", 113417)).toBe(
      "anilist-113417",
    );
    expect(resolveTvDetailRouteId("/anime/113417", 113417)).toBe(
      "anilist-113417",
    );
    expect(resolveTvDetailRouteId("/series/85937", 85937)).toBe("85937");
    expect(
      resolveTvDetailRouteId("/series/85937?anilistId=154587", 85937),
    ).toBe("85937");
  });
});
