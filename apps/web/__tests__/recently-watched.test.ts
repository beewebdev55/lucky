...
describe("collectRecentlyWatchedStubs", () => {
  ...
  it("builds item hrefs and titles", () => {
    expect(buildRecentlyWatchedHref("movie", 1)).toBe("/peliculas/1");
    expect(buildRecentlyWatchedHref("tv", 2, 3)).toBe("/series/2?season=3");
    ...
    expect(item.href).toBe("/series/1399?season=1");
