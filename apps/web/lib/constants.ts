...
export const LOGGER_TITLE = "[Cuevana 3]";

export const SITE_URL = "https://cuevana33.lat";
export const UMAMI_URL = "https://analytics.cuevana33.lat";
...
export const SITE_NAME = "Cuevana 3";
export const DEFAULT_DESCRIPTION =
  "Cuevana 3 is an open-source, no-cost, and ad-free movie and TV stream aggregator.";
...
export const MAGIC_LINK_RESEND_FROM =
  ...
  (process.env.NODE_ENV === "production"
    ? "Cuevana 3 <hello@cuevana33.lat>"
    : "Cuevana 3 <delivered@resend.dev>");
export const MAGIC_LINK_RESEND_SUBJECT = "Sign in to Cuevana 3";
